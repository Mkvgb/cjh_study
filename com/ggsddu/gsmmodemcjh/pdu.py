...
def _encodeTimestamp(timestamp):
    ...
    Note: the specified timestamp must have a UTC offset set; you can use gsmmodemcjh.util.SimpleOffsetTzInfo for simple cases
    ...
    if timestamp.tzinfo == None:
        raise ValueError('Please specify time zone information for the timestamp (e.g. by using gsmmodemcjh.util.SimpleOffsetTzInfo)')
