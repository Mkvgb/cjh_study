...
for i in range(3):
    ...
    publisher.publish(json.dumps({"msg_list": ["externals.sms_send",],"deliver_data": {"cells": ["15801051609"], "content": "【安乡大数据实战平台】某某人 mac(" + str(i+1) + "),于2020-xx-xx xx:xx:xx，出现在2组—潺陵路农商行"}}))  # 传字符串即可
