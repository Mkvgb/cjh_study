...
class UpdateTimeEleFence(object):
    def __init__(self, spark):
        self.spark = spark
        self.PGSQL_URL_analysis = "jdbc:postgresql://192.168.9.214:5432/police_analysis_db"
    ...
    def update_time_pla(self, df_ef, _df_pla_old, df_pla_old):
        ...
        if not df.empty:
            ...
            with PGSQLOpr("192.168.9.214", 5432, "police_analysis_db", "postgres", "postgres") as opr:
                opr.update_cursor()
